(function() {
	...
	*/
	console.log( '\nOperation:');
	var operation = justMod2Or3.reduce(function(numMod, numAtual) {
		return (numMod + 1) * numAtual;
	}, 0);
	...
	*/
	console.log( '\nOperation 2:');
	var operation2 = justMod2Or3.reduceRight(function(numMod, numAtual) {
		return (numMod + 1) * numAtual;
	}, 0);
	...
	*/
	...
	console.log('compara dois objetos');
